    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="x_content">
                ...
                <table id="crudTable" class="table table-striped responsive-utilities jambo_table">
                    <thead>
                    <tr class="headings">
                        @if ($crud->details_row)
...
@section('after_styles')
    ...
    <link href="{{ asset('vendor/production/') }}/css/datatables/tools/css/dataTables.tableTools.css" rel="stylesheet">
